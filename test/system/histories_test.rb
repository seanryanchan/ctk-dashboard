...
class HistoriesTest < ApplicationSystemTestCase
  ...
  test "creating a History" do
    ...
    fill_in "Date action", with: @history.date_action
    fill_in "Log in timestamp", with: @history.log_in_timestamp
    fill_in "Log out timestamp", with: @history.log_out_timestamp
